      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="p-2.5 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl relative group transition-all">
            ...
            <span className="absolute top-2 right-2.5 w-2 h-2 bg-red-600 rounded-full border-2 border-white dark:border-slate-950" />
          </button>
          ...
          <div className="flex items-center gap-3 pl-2">
            ...
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-red-600 to-rose-400 flex items-center justify-center text-white font-bold text-sm shadow-md">
              DR
            </div>
          </div>
        </div>
